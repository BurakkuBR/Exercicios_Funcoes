...
/* - **Exercícios de escrita de código**
    ...
    1. Escreva as funções explicadas abaixo:
        ...
        function informacoes (){
            return "Eu sou Fábio, tenho 28 anos, moro em São Leopoldo e sou estudante."
        }
        ...
        function informacoesNovas (nome,idade,cidade,profissao){
            
            return `Eu sou ${nome}, tenho ${idade} anos, moro em ${cidade} e sou ${profissao}`
        }
        alert (informacoesNovas('Fábio' , 28 , 'São Leopoldo' , 'estudante' ));
        */
